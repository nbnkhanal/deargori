...
module.exports = (app, passport) => {
    //getting instance of express from server.js
    app.get('/', (req, res, next) =>{
        ...
        if(req.session.cookie.originalMaxAge !== null){
            ...
            School.find({}, (err, result) => {
                res.render('index', {title: 'Index || DearGori', data:result});
            });
        }
    });
    ...
    app.get('/signup', (req, res) => {
        ...
        res.render('user/signup', {title: 'Sign Up || DearGori', messages: errors, hasErrors: errors.length > 0});
    });

    //calling post method if success in user and password
    ...
    app.get('/login', (req, res) => {
        var errors = req.flash('error');
        res.render('user/login', {title: 'Login || DearGori', messages: errors, hasErrors: errors.length > 0});
    });
...
//        successRedirect: '/home',
    ...
    app.get('/home', (req, res) => {
        res.render('home', {title: 'Home || DearGori', user: req.user});
    });
    ...
    app.post('/forgot', (req, res, next) => {
        async.waterfall([
            ...
            function(rand, user, callback){
                ...
                var mailOptions = {
                    to: user.email,
                    from: 'DearGori '+'<'+secret.auth.user+'>',
                    subject: 'DearGori Application Password Reset Token',
